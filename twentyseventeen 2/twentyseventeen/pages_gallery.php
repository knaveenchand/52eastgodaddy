...
<h1 class="pageTitle">Pages Gallery</h1>
  <div class="owl-carousel" id="coverSlider">
<?php
       $user_id=get_current_user_id();
       global $wpdb;
		   $sql = "SELECT image_id,image_url,price,page_title from custom_gallery where page_name='page_design'";
        ...
        $total_orders =$count_order[0]->total;
				echo "<div class='item'><img class='mySlides' src='".$gallery->image_url."' title='cover page gallery' alt='cover page gallery'  number='".$gallery->image_id."'>
          ...
          echo "
          <a class='button' id='wishlist'><i class='fa fa-heart'></i> Add to Wishlist</a>
...
<form id="coverform" method="POST" action="<?php echo home_url();?>/page-design/"><input type="hidden" value="" id="cdesign" name="cdesign"></form>
...
#coverSlider .owl-nav button{margin:10px 10px 0;}
...
function showLikes(design_id){
      ...
      /*jQuery.ajax({
            ...
            success: function (data) { //alert(data);
              ...
              var div_like ="#likecounter"+current_design;
              jQuery(div_like).html(numbersArray[0]+" Likess");
              var div_order="#ordercounter"+current_design;
              jQuery(div_order).html(numbersArray[1]+" Orderss");
              console.log(div_like);console.log(div_order);
