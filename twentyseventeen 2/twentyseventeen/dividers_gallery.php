...
<h1 class="pageTitle">Divider Gallery</h1>
  <div class="owl-carousel" id="coverSlider">
    <?php
    global $wpdb;
    $user_id=get_current_user_id();
    $sql = "SELECT image_id,image_url,page_title,pid,variation_id,price from custom_gallery where page_name='divider_page'";
...
<form id="coverform" method="POST" action="<?php echo home_url();?>/divider/"><input type="hidden" value="" id="cdesign" name="cdesign"></form>
<style type="text/css">
