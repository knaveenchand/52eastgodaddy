...
// Add theme support for Nav Condition.
...
function custom_pre_get_posts_query( $q ) {
    ...
    $tax_query[] = array(
           ...
           'field' => 'slug',
           'terms' => array('calender'), // Don't display products of custom category on the shop page.
           'operator' => 'NOT IN'
    );
...
// Save the custom field 'billing_ship
function save_additional_account_details( $user_ID ){
   /* $billing_address_1 = ! empty( $_POST['billing_address_1'] ) ? wc_clean( $_POST['billing_address_1'] ) : '';*/
...
function custosm_login_logo() {
    echo '<style type ="text/css">.login h1 a { display:none; }</style>';
    echo '<style type="text/css">
body.login div#login h1 a {
background-image: url('.site_url().'/wp-content/uploads/2019/12/cropped-52-East-Logo-IV.png); //Add your own logo image in this url
padding-bottom: 10px;
}</style>';
echo '<style type ="text/css">.login h1 a { display:block!important; }</style>';
